...
dataSet[dataSetVersion].options = [
  {
    ...
    sub: [
      ...
      { name: "The Rise and Fall of Ziggy Stardust and the Spiders From Mars", key: "ZS" },
      ...
      { name: "1. Outside", tooltip: "aka 1. Outside (The Nathan Adler Diaries- A Hyper Cycle)" key: "Outside" },
  ...
  },
  {
    ...
    checked: true,
    sub: [ { name: "Early Pre-Album Tracks", key: "PAT" }, 
  ...
  },
  {
    ...
    key: "duplicates",
    tooltip: "This will remove any songs that appear on two releases in basically the same form."
  },
  {
    name: "Remove Covers",
    key: "covers",
...
dataSet[dataSetVersion].characterData = [
  {
    ...
    img: "c5DqpgX.png",
    opts: {
      series: [ "book", "EoSD", "PCB", "IaMP", "IN", "PoFV", "StB", "SWR", "MoF", "SA", "UFO", "soku", "DS", "TD", "HM", "DDC", "ISC", "ULiL", "LoLK", "AoCF", "HSiFS", "VD", "WBaWC", "UM", "17.5", "100BM", "UDoALG", "FW" ],
      stage: ["st4"]
    }
  },
  {
    ...
    img: "tJnkSzK.png",
    opts: {
      series: [ "book", "EoSD", "PCB", "IaMP", "IN", "PoFV", "StB", "SWR", "MoF", "SA", "UFO", "soku", "DS", "GFW", "TD", "HM", "DDC", "ISC", "ULiL", "LoLK", "AoCF", "HSiFS", "VD", "WBaWC", "UM", "17.5", "100BM", "UDoALG", "FW" ],
      stage: ["st4", "ex"]
    }
  },
  {
